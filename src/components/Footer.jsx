      ...
      <Container>
        <div className="py-10">
          <nav className="text-sm" aria-label="quick links">
            <div className="-my-1 flex justify-center gap-x-6">
              ...
              <NavLink href={routes.mealplan}>Meal Plan</NavLink>
            </div>
          </nav>
        </div>
        <div className="flex flex-col items-center border-t border-slate-400/10 py-8 sm:flex-row-reverse sm:justify-between">
          <div className="flex gap-x-6">
            <Link
              href="https://github.com/khaosophy/peppercorn"
              className="group"
              aria-label="Peppercorn on GitHub"
            >
              <svg
                aria-hidden="true"
          ...
          <p className="mt-6 text-sm text-slate-500 sm:mt-0">
            Copyright &copy; {new Date().getFullYear()} Peppercorn. All rights reserved.
          </p>
        </div>
      </Container>
    </footer>
